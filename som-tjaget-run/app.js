  ...
  const GAP_MS=300;        // liten paus mellan spelare i den sekventiella kön
  const LEADER_PAUSE_MS=2200; // dramatisk paus (med pulserande skelett) precis innan ledaren/ledarna kröns
